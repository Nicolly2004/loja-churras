...
public class Cliente {
    ...
    public String toString(){
        return "Nome: "+ this.getNome() + "\n"+
                ...
                "Crédito Disponível: "+ this.getCredito() + "\n"+
                "-----\n"+
                this.getEndereco();
    }
    ...
    private  static Cliente convertCliente(ResultSet result) throws SQLException{
       ...
       try{
           Endereco endereco = Endereco.getEnderecoClienteId(result.getInt("id"));
           return new Cliente(
                   result.getInt("id"),
    ...
    public static List<Cliente> searchCliente(String where){
        ...
        try{
            ...
            while (resultSet.next()){
                 results.add(convertCliente(resultSet));
            }
            return results;
