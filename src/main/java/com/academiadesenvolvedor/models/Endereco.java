...
public class Endereco {
    ...
    public  Endereco createEndereco(int cliente_id){
        ...
        try{
            ...
            stm.setString(2,getRua());
            stm.setString(3,getBairro());
            stm.setString(4,getCep());
            stm.setString(5,getCidade());
            stm.setString(6,getUf());


            int rowsCreateded = stm.executeUpdate();
    ...
    public static Endereco getEnderecoClienteId(int cliente_id){
        Connection conn = DbConnection.getConnection();
